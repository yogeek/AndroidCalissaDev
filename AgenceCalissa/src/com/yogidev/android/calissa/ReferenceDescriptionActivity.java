...
import com.yogidev.android.calissa.data.bean.Reference;
...
//		shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Partage de référence chez Calissa Immobilier");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
			...
			case R.id.action_share:
				...
				intent.putExtra(Intent.EXTRA_SUBJECT, "Partage de référence chez Calissa Immobilier");
